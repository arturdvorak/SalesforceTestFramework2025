...
public class AccountFactory {
    ...
    public Account getAccount(String parentAccountName) {
        return Account.builder()
                .accountName(usFaker.company().name().replaceAll("[^a-zA-Z0-9\\s]", ""))
                ...
                //.ownership(usFaker.options().option("Public", "Private", "Subsidiary"))
                .ownership(usFaker.options().option("Other"))
